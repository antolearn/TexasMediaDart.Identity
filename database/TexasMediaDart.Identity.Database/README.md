...
```bash
sqlpackage /Action:Publish /SourceFile:bin/Debug/TexasMediaDart.Identity.Database.dacpac /TargetServerName:localhost /TargetDatabaseName:TexasMediaDart.Identity.Database
```
